...
Формула: `xp_to_next(level) = round(50 * level^1.4)` (округление до 10). На M1 значения сверки выше — канон; формула — для расширения в M3+.
...
# XP
xp_to_next(level) = round_to_10(50 * level^1.4)
