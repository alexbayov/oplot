...
```
Day R (лут, вес, реалистичные предметы)
+ Lineage (XP → уровни → перки, гринд-петля)
+ Tarkov (вес = жадность vs выживание)
+ Firewatch (радио, доверие, неизвестность)
+ Модульная сборка оружия (компоненты → уникальные статы)
```
